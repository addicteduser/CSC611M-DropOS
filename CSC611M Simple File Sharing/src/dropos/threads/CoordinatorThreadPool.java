...
/**
 * The {@link CoordinatorThreadPool} creates a {@link LinkedBlockingQueue} which will hold the {@link Socket} instances added by the {@link DropServer}. One of
 * the sixteen (16) instances of the {@link CoordinatorConnectionHandler} will then poll for the {@link Socket} and handle the connection.
 * 
 * @author Kevin
 *
 */
